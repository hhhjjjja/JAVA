...
public class BigEnemy extends Enemy{		
    ...
    public BigEnemy(int x, int y, float delta_x, float delta_y, int max_x, int max_y, float delta_y_inc) {
    	super(0,0,0,0,0,0,0);
        x_pos = x;
        y_pos = y;
    	...
    	img = tk.getImage("src/resourcepack/benemy.png");
  ...
  public boolean isCollidedWithBomb(Bomb bombs) {
    ...
    public void draw(Graphics g, ImageObserver i) {
        g.drawImage(img, (int)x_pos-22, (int)y_pos, i);
    }
